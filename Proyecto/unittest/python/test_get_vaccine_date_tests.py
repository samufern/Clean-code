...
class TestGetVaccineDate(TestCase):
        ...
        for file_name,expected_value in param_list_nok:
            with self.subTest(test=file_name):
                ...
                with self.assertRaises(VaccineManagementException) as c_m:
                    my_manager.get_vaccine_date(file_test, "2022-08-08")
    ...
    def test_date_has_passed(self):
        ...
        with self.assertRaises(VaccineManagementException) as exception:
            my_manager.get_vaccine_date(file_test, "2021-03-08")
        self.assertEqual(exception.exception.message, "Date has passed")
